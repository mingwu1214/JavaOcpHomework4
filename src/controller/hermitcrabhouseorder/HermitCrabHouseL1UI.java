...
public class HermitCrabHouseL1UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HermitCrabHouseL1UI frame = new HermitCrabHouseL1UI();
			        // Get the screen size
	 ...
	 * Create the frame.
	 */
	public HermitCrabHouseL1UI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(HermitCrabHouseL1UI.class.getResource("/images/hermit-crab_64.png")));
		...
		JLabel lblNewLabel = new JLabel("奢華尊貴級殼，極致舒適，體驗非凡的豪華生活。");
		lblNewLabel.setBounds(114, 103, 672, 50);
		lblNewLabel.setForeground(new Color(95, 158, 160));
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 18));
		lblNewLabel.setBackground(Color.WHITE);
		contentPane.add(lblNewLabel);
		
		JRadioButton dd_2 = new JRadioButton("   木弧吊窩");
		...
		JRadioButton dd_1 = new JRadioButton("   穀倉木屋");
        ...
        pic01.setIcon(new ImageIcon(HermitCrabHouseL1UI.class.getResource("/images/L1N1.png")));
        ...
        pic01_1.setIcon(new ImageIcon(HermitCrabHouseL1UI.class.getResource("/images/L1N2.png")));
        ...
        txtrBc.setText("穀倉木屋為寄居蟹提供溫暖舒適的居所，結合鄉村風情與自然元素，讓小伙伴感受到家的溫暖，享受寧靜安逸的生活。");
        contentPane.add(txtrBc);
        
        JTextArea txtrBc_1 = new JTextArea();
        txtrBc_1.setBounds(502, 484, 222, 136);
        txtrBc_1.setWrapStyleWord(true);
        txtrBc_1.setText("木弧吊窩以創新的設計，將木頭捆綁成半圓形拱起，為寄居蟹營造獨特且溫馨的居住空間，享受與眾不同的生活體驗。");
        txtrBc_1.setRows(1);

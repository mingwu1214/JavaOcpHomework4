...
public class HermitCrabHouseL2UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HermitCrabHouseL2UI frame = new HermitCrabHouseL2UI();
			        // Get the screen size
	 ...
	 * Create the frame.
	 */
	public HermitCrabHouseL2UI() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(HermitCrabHouseL2UI.class.getResource("/images/hermit-crab_64.png")));
		...
		JLabel lblNewLabel = new JLabel("科技智享級殼，創新設計，帶來智慧新體驗。");
		...
		JRadioButton dd_2 = new JRadioButton("   未來探索粉");
		...
		JRadioButton dd_1 = new JRadioButton("   智能光芒黃");
        ...
        pic01.setIcon(new ImageIcon(HermitCrabHouseL2UI.class.getResource("/images/L2N1.png")));
        ...
        pic01_1.setIcon(new ImageIcon(HermitCrabHouseL2UI.class.getResource("/images/L2N2.png")));
        ...
        txtrBc.setText("智能光芒黃為您的寄居蟹帶來未來科技的光芒，讓它在每一個角落都能感受到智慧與創新的力量，探索未知世界。");
        contentPane.add(txtrBc);
        
        JTextArea txtrBc_1 = new JTextArea();
        txtrBc_1.setBounds(502, 484, 222, 136);
        txtrBc_1.setWrapStyleWord(true);
        txtrBc_1.setText("未來探索粉為您的寄居蟹打造一個充滿科技感的居所，讓它彷彿穿越到未來的時空，感受前沿科技帶來的舒適與美好。");
        txtrBc_1.setRows(1);
